// Importation du modèle de artcile
const Article = require("../models/article");
// Importation du module "fs"
const fs = require("fs");

// Logique d'affichage de toutes les articles
...
// Logique d'affichage d'une seule artcile
...
// Logique de modification d'une artcile
exports.modifyArticle = (req, res, next) => {
  // recuperation du fichier
  if (req.file) {
    // Instruction trouver une artcile par son ID
    ...
    // Sinon recuperation de tous les élément du body, et update de l'ID de la artcile et et de l'objet artcile
...
exports.likeArticle = (req, res, next) => {
  ...
  if (req.body.like === 1) {
    Article.updateOne(
      //récuperation de la artcile par son ID
      { _id: req.params.id },
      {
      ...
      .then((artcile) => res.status(200).json({ message: "Like ajouté" }))
  ...
  // Sinon l'utilisateur à déjà liker/dislike
    ...
    Article.findOne({ _id: req.params.id })
      .then((article) => {
        ...
        //Si la artcile et déjà dislike et que l'utilisateur est déjà dans le tableau, supprime le like
